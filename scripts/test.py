...
if __name__ == "__main__":
    ...
    args.add_argument(
        "-c",
        "--config",
        default=None,  # "config/uvg-720p/beauty-3M_vmaev2-adaptive3d-nervb3d_b2xf4-cosinelr-10k_300e.yaml",
        type=str,
    ...
    args.add_argument(
        "-r",
        "--resume",
        default=None,  # "../ckpt/720p/beauty-3M_vmaev2-adaptive3d-nervb3d_b2xf4-cosinelr-10k_300e-ckpte300.pth",
        type=str,
